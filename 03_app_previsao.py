...
para Ledstar, SX Lighting e Tecnowatt.
...
# ── Sidebar ───────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown('## ⚙️ Parâmetros da Instalação')
    st.divider()
...
# ── Gráfico comparativo ────────────────────────────────────────────────────────
tab_lm, tab_w, tab_ef = st.tabs(['📊 Fluxo Luminoso (lm)', '⚡ Potência (W)', '🔀 Eficiência (lm/W)'])
